...
def test_verify_logo(page:Page):
    page.goto("https://demo.nopcommerce.com/")
    page.wait_for_timeout(500)
    logo = page.get_by_text("Welcome to our store")
    expect(logo).to_be_visible()
"""
""""
...
"""def test_role(page: Page):
    #page.get_by_role()
    page.goto("https://practicetestautomation.com/")
    #role1 = page.get_by_role("heading", name = "Get a FREE XPath cheat sheet")
    role1 = page.get_by_role(role="heading", name = "Get a FREE XPath cheat sheet")
