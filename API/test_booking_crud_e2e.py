...
def test_create_booking(request_context):
    data = read_json("API/testdata/POST_request_body.json")
...
def test_create_token(request_context):
    ...
    data = read_json("API/testdata/TOKEN_request_body.json")
...
def test_parital(request_context):
    data = read_json("API/testdata/PATCH_request_body.json")
...
def test_full_update(request_context):
    data = read_json("API/testdata/PUT_request_body.json")
